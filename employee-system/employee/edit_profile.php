                ...
                <div class="row ">
                    ...
                    <!-- <div class="col-12"> -->
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select name="gender" id="gender" required class="form-control" value="<?= $employee['gender'] ?>">
                        ...
                        <div class="col-md-6 form-group mb-3">
                            ...
                            <select name="employee_type" id="employee_type" required class="form-control" value="<?= $employee['employee_type'] ?>">
                        ...
                        <div class="col-md-12 form-group mb-3">
                            ...
                            <textarea name="address" id="address" class="form-control" value="<?= $employee['address'] ?>"></textarea>
                        </div>
                        ...
                        <div class="col-md-10 form-group mb-3">
                            ...
                            <input type="file" id="photo" name="photo" accept="image/*" class="form-control" value="<?= $employee['photo'] ?>">
                        </div>
