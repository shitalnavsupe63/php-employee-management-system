    ...
    <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample">
        ...
        <div class="offcanvas-body text-center">
            ...
            <ul class="list-group list-group-flush mt-1">
                <li class="list-group-item "><a href="../employee/registration.php" class="a text-decoration-none">Employee Registration</a></li>
                <li class="list-group-item"><a href="../employee/login.php" class="a text-decoration-none">Employee Login</a></li>
                <li class="list-group-item"><a href="login.php" class="a text-decoration-none">Admin Login</a></li>
